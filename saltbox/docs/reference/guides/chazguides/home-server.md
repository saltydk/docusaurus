...
This is just an example of the install.  You should refer to the actual [install docs](/saltbox/install).
...
I ran the first dependency script on [this page](/saltbox/install).
