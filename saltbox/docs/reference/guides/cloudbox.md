...
- Copy `rclone.conf` to `/srv/git/saltbox`  and edit the configuration files as needed. You can follow the [saltbox install instructions for saltbox for this](/saltbox/install)
