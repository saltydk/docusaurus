...
| Details     |             |             |             |
|-------------|-------------|-------------|-------------|
| [:material-home: Project home ](https://github.com/kiranshila/doplarr) | [:octicons-link-16: Docs](https://github.com/kiranshila/doplarr) | [:octicons-mark-github-16: Github](https://github.com/kiranshila/doplarr) | [:material-docker: Docker ](https://ghcr.io/kiranshila/doplarr)|
...
!!! Note
      📢 You may also override the default setting of Doplarr working with overseer, to work with Sonarr and Radarr. Additional informations here [:octicons-link-16: Documentation](https://github.com/kiranshila/Doplarr/blob/main/README#sonarrradarr) .
