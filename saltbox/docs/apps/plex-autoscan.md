...
| Details     |             |             |             |
|-------------|-------------|-------------|-------------|
| :material-home: Project home | :octicons-link-16: Docs | [:octicons-mark-github-16: Github](https://github.com/l3uddz/plex_autoscan) | :material-docker: Docker |
...
#### Do a One-Time, Manual Scan in Plex
 ...
 - For more info, see [this](/apps/plex).

#### Add Your Plex Access Token into Plex Autoscan Config

_You can skip this step if you entered in your Plex credentials in [accounts.yml](/reference/accounts) during setup._

_Note: For Mediabox / Feederbox setups, the following will be done on the Mediabox._


   1. Get your Plex Autoscan Token [here](/reference/plex_auth_token).
...
The Plex Autoscan URL is needed during the setup of [Sonarr](/apps/sonarr#plex-autoscan), [Radarr](/apps/radarr#plex-autoscan), and [Lidarr](/apps/lidarr#plex-autoscan).
