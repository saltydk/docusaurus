...
| Details     |             |             |             |
|-------------|-------------|-------------|-------------|
| [:material-home: Project home ](https://sonarr.tv/) | [:octicons-link-16: Docs](https://wiki.servarr.com/sonarr/) | [:octicons-mark-github-16: Github](https://github.com/Sonarr/Sonarr) | [:material-docker: Docker ](https://hub.docker.com/r/hotio/sonarr)|
...
This is used during the setup of [Overseer](overseerr) and [Organizr](/apps/organizr).
...
Are you setting Saltbox up for the first time?  Continue to [Radarr](/apps/radarr).
